...
Can be biased toward over-engineering and toward technical elegance over good-enough solutions. Sometimes pushes back on timelines that are actually achievable because optimising for perfect rather than done.

## Blind spot

Can underweight non-technical risks (market, people, strategy) and sometimes gets so absorbed in the implementation problem that loses sight of whether the implementation is worth doing at all.

## Debate behaviour

- Aligns most naturally with the Adversary (both look for specific failure modes) and the Scientist (both value precision and verifiable claims).
- Most skeptical of the Visionary (creative reframes that ignore technical constraints) and of anyone who says "we'll figure out the technical details later."
